  ...
  return (
    <div className={`${updateModal ? '' : 'hidden'} w-full h-screen bg-[#2a2a2a3c]/10 fixed inset-0 backdrop-blur-sm`}>
      <div className='w-full h-full flex flex-row items-center justify-center'>
        <div className='w-[700px] h-[450px] bg-white rounded-md shadow-md flex flex-col p-10 items-start gap-3 overflow-y-scroll relative'>
          <XSquare
          ...
          <form
            ...
            <div className='flex flex-row gap-5'>
              ...
              <div className={` ${statusOptions ? '' : 'hidden'}  w-[150px] h-auto bg-white flex flex-col shadow-md absolute p-2 items-center right-[15px] top-[20px] rounded-md cursor-pointer`}>
                <p
            ...
            <div className='flex flex-row gap-5'>
              ...
              <div className={` ${priorityOptions ? '' : 'hidden'}  w-[150px] h-auto bg-white flex flex-col shadow-md absolute p-2 items-center right-[15px] top-[200px] rounded-md cursor-pointer`}>
                <p
